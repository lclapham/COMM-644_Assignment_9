...
let userOneAccountBalance = [["01/20/2020", "deposit", 200.00, "", "", 200.00],
["01/21/2020", "", "", "withdraw", 20.00, 180.00]];

let userTwoAccountBalance = [["08/20/2020", "deposit", 500.00, "", "", 500.00],
["08/21/2020", "", "", "withdraw", 200.00, 300.00]];
...
//    tr = document.getElementById(tr);
    ...
    amount1.innerHTML = arr[idNum][2];
    withdraw.innerHTML = arr[idNum][3];
    amount2.innerHTML = arr[idNum][4];
    balance.innerHTML = arr[idNum][5];
